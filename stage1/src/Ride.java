...
public class Ride {
    ...
    /**
     * The getLatestFin method, returns the latest a car can be finish to be eligible for a distance score
     *
     * @return the latest the car finish to be eligible for a distance score.
     */

    public int getLatestFin() {

        return latestFinish; //returns the latest finish that the car can still get bonus for.
    }
}
